...
```javascript
plot = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/plot@v0.4.1-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/plot@v0.4.1-umd/browser.js"></script>
```
